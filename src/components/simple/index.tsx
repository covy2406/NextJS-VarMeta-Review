  ...
  return (
    <div className='bg-fixed bg-cover bg-center py-[8.125rem] container mx-auto'>
      <div className='text-center mx-auto max-w-[660px]'>
        <p className="text-black text-center font-bold mb-6 text-5xl leading-[1.2em]">Frequently Asked Questions</p>
        <p>Find answers to the most common questions, covering everything from setup to advanced features, to help you get the most out of the platform.</p>
      </div>
      <div>
